...
import { IAsyncQueueTaskEventListener, TAsyncQueueTaskEventHandler, TAsyncQueueTaskEventNames } from "./type/TAsyncQueueTaskEventHandlers"
...
export class AsyncQueueTaskEventsManager {
    ...
    public addEventListener(eventName: TAsyncQueueTaskEventNames, listenerEventHandler: TAsyncQueueTaskEventHandler): string {
        const listenerId = createId(this._idPrefix)
